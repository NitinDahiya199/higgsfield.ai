/**
 * Custom SVG Icons
 * Minimal, precise icons matching higgsfield.ai aesthetic
 */
...
export function SparkleIcon({ className = "w-4 h-4" }: { className?: string }) {
  return (
    <svg className={className} fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
      <path d="M12 0l2.4 4.8L20 7.2l-4.8 2.4L12 14.4l-3.2-4.8L4 7.2l5.6-2.4L12 0zm0 16l1.6 3.2L18 20.8l-3.2 1.6L12 24l-2.8-1.6L6 20.8l4.4-1.6L12 16z" />
    </svg>
  );
}
...
export function CharacterIcon({ className = "w-6 h-6" }: { className?: string }) {
  return (
    <svg
      className={className}
      fill="none"
...
export function InpaintIcon({ className = "w-6 h-6" }: { className?: string }) {
  return (
    <svg
      className={className}
      fill="none"
...
export function UpscaleIcon({ className = "w-6 h-6" }: { className?: string }) {
  return (
    <svg
      className={className}
      fill="none"
...
export function FaceSwapIcon({ className = "w-6 h-6" }: { className?: string }) {
  return (
    <svg
      className={className}
      fill="none"
...
export function SparkleIcon2({ className = "w-6 h-6" }: { className?: string }) {
  return (
...
export function GhostIcon({ className = "w-6 h-6" }: { className?: string }) {
  return (
    <svg className={className} fill="currentColor" viewBox="0 0 24 24">
      <path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 3.5 9.5 7 12 3.5-2.5 7-6.75 7-12 0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5S10.62 6.5 12 6.5s2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z" />
    </svg>
  );
}
...
export function getIcon(iconName: string, className = "w-6 h-6") {
  const icons: Record<string, React.ReactNode> = {
    ...
    character: <CharacterIcon className={className} />,
    inpaint: <InpaintIcon className={className} />,
    upscale: <UpscaleIcon className={className} />,
    faceSwap: <FaceSwapIcon className={className} />,
    lightbulb: <LightbulbIcon className={className} />,
    sparkle: <SparkleIcon2 className={className} />,
    ...
    paperPlane: <PaperPlaneIcon className={className} />,
    ghost: <GhostIcon className={className} />,
